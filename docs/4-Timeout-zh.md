[← Transport](3-Transport-zh.md) | 超时配置[(English)](5-Timeout.md) | [重试机制 →](5-Retry-zh.md)
...
Java SDK Client 使用的是 `com.squareup.okhttp.OkHttpClient`，可以通过设置 `connectTimeout`、`readTimeout` 和 `writeTimeout` 来控制请求的超时时间。
