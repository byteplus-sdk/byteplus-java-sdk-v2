...
public class DescribeRouteEntryListRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(destinationCidrBlock, maxResults, nextHopId, nextHopType, nextToken, pageNumber, pageSize, routeEntryId, routeEntryName, routeEntryType, routeTableId);
  }
