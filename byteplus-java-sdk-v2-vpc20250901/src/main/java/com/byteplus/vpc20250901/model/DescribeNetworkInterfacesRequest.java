...
import com.byteplus.vpc20250901.model.TagFilterForDescribeNetworkInterfacesInput;
...
public class DescribeNetworkInterfacesRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(instanceId, maxResults, networkInterfaceIds, networkInterfaceName, nextToken, pageNumber, pageSize, primaryIpAddresses, privateIpAddresses, projectName, securityGroupId, status, subnetId, tagFilters, type, vpcId, zoneId);
  }
