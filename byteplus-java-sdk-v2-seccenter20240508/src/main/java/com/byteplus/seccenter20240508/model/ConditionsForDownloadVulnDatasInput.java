...
/**
 * ConditionsForDownloadVulnDatasInput
 */



public class ConditionsForDownloadVulnDatasInput {
  ...
  public ConditionsForDownloadVulnDatasInput agentTags(List<String> agentTags) {
    this.agentTags = agentTags;
    return this;
  }

  public ConditionsForDownloadVulnDatasInput addAgentTagsItem(String agentTagsItem) {
  ...
  **/
  ...
  public ConditionsForDownloadVulnDatasInput assetName(String assetName) {
  ...
  **/
  ...
  public ConditionsForDownloadVulnDatasInput cloudProviders(List<String> cloudProviders) {
    this.cloudProviders = cloudProviders;
    return this;
  }

  public ConditionsForDownloadVulnDatasInput addCloudProvidersItem(String cloudProvidersItem) {
  ...
  **/
  ...
  public ConditionsForDownloadVulnDatasInput hostName(String hostName) {
  ...
  **/
  ...
  public ConditionsForDownloadVulnDatasInput IP(String IP) {
    this.IP = IP;
    return this;
  }
  ...
  **/
  ...
  public ConditionsForDownloadVulnDatasInput addLeafGroupIDsItem(String leafGroupIDsItem) {
  ...
  **/
  ...
  public ConditionsForDownloadVulnDatasInput status(List<String> status) {
    this.status = status;
    return this;
  }

  public ConditionsForDownloadVulnDatasInput addStatusItem(String statusItem) {
    if (this.status == null) {
  ...
  **/
  ...
  public ConditionsForDownloadVulnDatasInput topGroupID(String topGroupID) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ConditionsForDownloadVulnDatasInput conditionsForDownloadVulnDatasInput = (ConditionsForDownloadVulnDatasInput) o;
    return Objects.equals(this.agentTags, conditionsForDownloadVulnDatasInput.agentTags) &&
        Objects.equals(this.assetName, conditionsForDownloadVulnDatasInput.assetName) &&
  ...
  public String toString() {
    ...
    sb.append("class ConditionsForDownloadVulnDatasInput {\n");
