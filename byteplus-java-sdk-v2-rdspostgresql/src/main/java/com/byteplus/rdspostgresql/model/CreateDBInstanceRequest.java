...
import com.byteplus.rdspostgresql.model.ChargeInfoForCreateDBInstanceInput;
import com.byteplus.rdspostgresql.model.NodeInfoForCreateDBInstanceInput;
import com.byteplus.rdspostgresql.model.TagForCreateDBInstanceInput;
...
public class CreateDBInstanceRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowListIds, chargeInfo, dbEngineVersion, instanceName, nodeInfo, projectName, storageSpace, storageType, subnetId, tags, vpcId);
  }
