...
public class Credentials {
    ...
    public static Credentials getEnvCredentials() {
        ...
        credentials.accessKey = System.getenv("BYTEPLUS_ACCESS_KEY");
        credentials.secretKey = System.getenv("BYTEPLUS_SECRET_KEY");
        credentials.sessionToken = System.getenv("BYTEPLUS_SESSION_TOKEN");
        return credentials;
    }
