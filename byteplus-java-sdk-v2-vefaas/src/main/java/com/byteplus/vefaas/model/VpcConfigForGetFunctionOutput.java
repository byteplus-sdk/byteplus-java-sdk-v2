...
public class VpcConfigForGetFunctionOutput {
  ...
  **/
  ...
  public VpcConfigForGetFunctionOutput securityGroupIds(List<String> securityGroupIds) {
  ...
  **/
  ...
  public VpcConfigForGetFunctionOutput subnetIds(List<String> subnetIds) {
