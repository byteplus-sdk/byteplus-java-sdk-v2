...
/**
 * RangeForAddRaspConfigInput
 */



public class RangeForAddRaspConfigInput {
  ...
  public RangeForAddRaspConfigInput agentIDList(List<String> agentIDList) {
    this.agentIDList = agentIDList;
    return this;
  }

  public RangeForAddRaspConfigInput addAgentIDListItem(String agentIDListItem) {
  ...
  **/
  ...
  public RangeForAddRaspConfigInput allHost(Boolean allHost) {
  ...
  **/
  ...
  public RangeForAddRaspConfigInput leafGroupIDs(List<String> leafGroupIDs) {
    this.leafGroupIDs = leafGroupIDs;
    return this;
  }

  public RangeForAddRaspConfigInput addLeafGroupIDsItem(String leafGroupIDsItem) {
  ...
  **/
  ...
  public RangeForAddRaspConfigInput singleGroupPath(String singleGroupPath) {
  ...
  **/
  ...
  public RangeForAddRaspConfigInput singleHostname(String singleHostname) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RangeForAddRaspConfigInput rangeForAddRaspConfigInput = (RangeForAddRaspConfigInput) o;
    return Objects.equals(this.agentIDList, rangeForAddRaspConfigInput.agentIDList) &&
        Objects.equals(this.allHost, rangeForAddRaspConfigInput.allHost) &&
        Objects.equals(this.leafGroupIDs, rangeForAddRaspConfigInput.leafGroupIDs) &&
        Objects.equals(this.singleGroupPath, rangeForAddRaspConfigInput.singleGroupPath) &&
        Objects.equals(this.singleHostname, rangeForAddRaspConfigInput.singleHostname);
  }
  ...
  public String toString() {
    ...
    sb.append("class RangeForAddRaspConfigInput {\n");
