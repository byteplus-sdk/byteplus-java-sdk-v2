...
/**
 * ListResourceReservationPlansRequest
 */



public class ListResourceReservationPlansRequest {
  @SerializedName("Ids")
  ...
  public ListResourceReservationPlansRequest ids(List<String> ids) {
    this.ids = ids;
    return this;
  }

  public ListResourceReservationPlansRequest addIdsItem(String idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  public ListResourceReservationPlansRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ListResourceReservationPlansRequest nameContains(String nameContains) {
  ...
  **/
  ...
  public ListResourceReservationPlansRequest pageNumber(Integer pageNumber) {
  ...
  **/
  ...
  public ListResourceReservationPlansRequest pageSize(Integer pageSize) {
  ...
  **/
  ...
  public ListResourceReservationPlansRequest sortOrder(SortOrderEnum sortOrder) {
  ...
  **/
  ...
  public ListResourceReservationPlansRequest states(List<String> states) {
    this.states = states;
    return this;
  }

  public ListResourceReservationPlansRequest addStatesItem(String statesItem) {
    if (this.states == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ListResourceReservationPlansRequest listResourceReservationPlansRequest = (ListResourceReservationPlansRequest) o;
    return Objects.equals(this.ids, listResourceReservationPlansRequest.ids) &&
        Objects.equals(this.name, listResourceReservationPlansRequest.name) &&
  ...
  public String toString() {
    ...
    sb.append("class ListResourceReservationPlansRequest {\n");
