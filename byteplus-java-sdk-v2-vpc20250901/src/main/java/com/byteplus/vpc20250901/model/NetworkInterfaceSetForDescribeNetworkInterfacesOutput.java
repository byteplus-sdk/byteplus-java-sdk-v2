...
import com.byteplus.vpc20250901.model.AssociatedElasticIpForDescribeNetworkInterfacesOutput;
import com.byteplus.vpc20250901.model.AttachmentForDescribeNetworkInterfacesOutput;
import com.byteplus.vpc20250901.model.PrivateIpSetsForDescribeNetworkInterfacesOutput;
import com.byteplus.vpc20250901.model.TagForDescribeNetworkInterfacesOutput;
...
public class NetworkInterfaceSetForDescribeNetworkInterfacesOutput {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, associatedElasticIp, attachment, createdAt, description, deviceId, macAddress, networkInterfaceId, networkInterfaceName, portSecurityEnabled, primaryIpAddress, privateIpSets, projectName, securityGroupIds, serviceManaged, status, subnetId, tags, type, updatedAt, vpcId, vpcName, zoneId);
  }
