...
import com.byteplus.rdsmssql.model.SecurityGroupBindInfoForCreateAllowListInput;
...
public class CreateAllowListRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowList, allowListCategory, allowListDesc, allowListName, allowListType, projectName, securityGroupBindInfos, userAllowList);
  }
