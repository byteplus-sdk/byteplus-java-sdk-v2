...
import com.byteplus.seccenter20240508.model.RiskForUpdateHostTagInput;
...
/**
 * ConditionsForUpdateHostTagInput
 */



public class ConditionsForUpdateHostTagInput {
  ...
  @SerializedName("Risk")
  private RiskForUpdateHostTagInput risk = null;
  ...
  public ConditionsForUpdateHostTagInput agentID(String agentID) {
  ...
  **/
  ...
  public ConditionsForUpdateHostTagInput agentIDList(List<String> agentIDList) {
    this.agentIDList = agentIDList;
    return this;
  }

  public ConditionsForUpdateHostTagInput addAgentIDListItem(String agentIDListItem) {
  ...
  **/
  ...
  public ConditionsForUpdateHostTagInput agentStatus(List<String> agentStatus) {
    this.agentStatus = agentStatus;
    return this;
  }

  public ConditionsForUpdateHostTagInput addAgentStatusItem(String agentStatusItem) {
  ...
  **/
  ...
  public ConditionsForUpdateHostTagInput allHost(Boolean allHost) {
  ...
  **/
  ...
  public ConditionsForUpdateHostTagInput cloudProviders(List<String> cloudProviders) {
    this.cloudProviders = cloudProviders;
    return this;
  }

  public ConditionsForUpdateHostTagInput addCloudProvidersItem(String cloudProvidersItem) {
  ...
  **/
  ...
  public ConditionsForUpdateHostTagInput hostname(String hostname) {
  ...
  **/
  ...
  public ConditionsForUpdateHostTagInput ip(String ip) {
    this.ip = ip;
    return this;
  }
  ...
  **/
  ...
  public ConditionsForUpdateHostTagInput leafGroupIDs(List<String> leafGroupIDs) {
    this.leafGroupIDs = leafGroupIDs;
    return this;
  }

  public ConditionsForUpdateHostTagInput addLeafGroupIDsItem(String leafGroupIDsItem) {
  ...
  **/
  ...
  public ConditionsForUpdateHostTagInput addPlatformsItem(String platformsItem) {
  ...
  **/
  ...
  public ConditionsForUpdateHostTagInput proxyName(String proxyName) {
  ...
  **/
  ...
  public ConditionsForUpdateHostTagInput proxyServerName(String proxyServerName) {
  ...
  **/
  ...
  public ConditionsForUpdateHostTagInput regions(List<String> regions) {
    this.regions = regions;
    return this;
  }

  public ConditionsForUpdateHostTagInput addRegionsItem(String regionsItem) {
  ...
  **/
  ...
  public ConditionsForUpdateHostTagInput risk(RiskForUpdateHostTagInput risk) {
    this.risk = risk;
    return this;
  }
  ...
  **/
  @Valid
  @Schema(description = "")
  public RiskForUpdateHostTagInput getRisk() {
    return risk;
  }

  public void setRisk(RiskForUpdateHostTagInput risk) {
    this.risk = risk;
  }

  public ConditionsForUpdateHostTagInput securityEnhancement(Boolean securityEnhancement) {
  ...
  **/
  ...
  public ConditionsForUpdateHostTagInput status(List<String> status) {
    this.status = status;
    return this;
  }

  public ConditionsForUpdateHostTagInput addStatusItem(String statusItem) {
    if (this.status == null) {
  ...
  **/
  ...
  public ConditionsForUpdateHostTagInput tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public ConditionsForUpdateHostTagInput addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public ConditionsForUpdateHostTagInput topGroupID(String topGroupID) {
  ...
  **/
  ...
  public ConditionsForUpdateHostTagInput virusFileAutoIsolate(Boolean virusFileAutoIsolate) {
  ...
  **/
  ...
  public ConditionsForUpdateHostTagInput visibility(List<String> visibility) {
    this.visibility = visibility;
    return this;
  }

  public ConditionsForUpdateHostTagInput addVisibilityItem(String visibilityItem) {
  ...
  **/
  ...
  public ConditionsForUpdateHostTagInput vpcIds(List<String> vpcIds) {
    this.vpcIds = vpcIds;
    return this;
  }

  public ConditionsForUpdateHostTagInput addVpcIdsItem(String vpcIdsItem) {
    if (this.vpcIds == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ConditionsForUpdateHostTagInput conditionsForUpdateHostTagInput = (ConditionsForUpdateHostTagInput) o;
    return Objects.equals(this.agentID, conditionsForUpdateHostTagInput.agentID) &&
        Objects.equals(this.agentIDList, conditionsForUpdateHostTagInput.agentIDList) &&
        Objects.equals(this.agentStatus, conditionsForUpdateHostTagInput.agentStatus) &&
        Objects.equals(this.allHost, conditionsForUpdateHostTagInput.allHost) &&
        Objects.equals(this.cloudProviders, conditionsForUpdateHostTagInput.cloudProviders) &&
        ...
        Objects.equals(this.regions, conditionsForUpdateHostTagInput.regions) &&
        Objects.equals(this.risk, conditionsForUpdateHostTagInput.risk) &&
        Objects.equals(this.securityEnhancement, conditionsForUpdateHostTagInput.securityEnhancement) &&
        Objects.equals(this.status, conditionsForUpdateHostTagInput.status) &&
        Objects.equals(this.tags, conditionsForUpdateHostTagInput.tags) &&
        Objects.equals(this.topGroupID, conditionsForUpdateHostTagInput.topGroupID) &&
        Objects.equals(this.virusFileAutoIsolate, conditionsForUpdateHostTagInput.virusFileAutoIsolate) &&
        Objects.equals(this.visibility, conditionsForUpdateHostTagInput.visibility) &&
        Objects.equals(this.vpcIds, conditionsForUpdateHostTagInput.vpcIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConditionsForUpdateHostTagInput {\n");
