...
import com.byteplus.vpc20250901.model.TagForDescribeSecurityGroupsOutput;
...
public class SecurityGroupForDescribeSecurityGroupsOutput {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, creationTime, description, projectName, securityGroupId, securityGroupName, serviceManaged, status, tags, type, vpcId);
  }
