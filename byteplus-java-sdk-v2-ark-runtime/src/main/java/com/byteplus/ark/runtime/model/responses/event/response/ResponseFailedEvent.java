package com.byteplus.ark.runtime.model.responses.event.response;
...
public class ResponseFailedEvent extends StreamEvent {
    ...
    public ResponseFailedEvent() {
        super(ResponsesConstants.EVENT_TYPE_RESPONSE_FAILED);
    }
