...
public class StatusForGetModelCustomizationJobOutput {
  ...
  public StatusForGetModelCustomizationJobOutput billableTokens(Long billableTokens) {
  ...
  **/
  ...
  public StatusForGetModelCustomizationJobOutput message(String message) {
  ...
  **/
  ...
  public StatusForGetModelCustomizationJobOutput outputExpiredTime(String outputExpiredTime) {
  ...
  **/
  ...
  public StatusForGetModelCustomizationJobOutput phaseTime(String phaseTime) {
  ...
  **/
  ...
  public StatusForGetModelCustomizationJobOutput queuePosition(Integer queuePosition) {
  ...
  **/
  ...
  public StatusForGetModelCustomizationJobOutput resumable(Boolean resumable) {
  ...
  **/
  ...
  public StatusForGetModelCustomizationJobOutput retryCount(Integer retryCount) {
  ...
  **/
  ...
  public StatusForGetModelCustomizationJobOutput retryLimit(Integer retryLimit) {
  ...
  **/
  ...
  public StatusForGetModelCustomizationJobOutput trainingTokensPerEpoch(Long trainingTokensPerEpoch) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StatusForGetModelCustomizationJobOutput statusForGetModelCustomizationJobOutput = (StatusForGetModelCustomizationJobOutput) o;
    return Objects.equals(this.billableTokens, statusForGetModelCustomizationJobOutput.billableTokens) &&
        Objects.equals(this.message, statusForGetModelCustomizationJobOutput.message) &&
        Objects.equals(this.outputExpiredTime, statusForGetModelCustomizationJobOutput.outputExpiredTime) &&
        Objects.equals(this.phase, statusForGetModelCustomizationJobOutput.phase) &&
        Objects.equals(this.phaseTime, statusForGetModelCustomizationJobOutput.phaseTime) &&
        Objects.equals(this.queuePosition, statusForGetModelCustomizationJobOutput.queuePosition) &&
        Objects.equals(this.resumable, statusForGetModelCustomizationJobOutput.resumable) &&
        Objects.equals(this.retryCount, statusForGetModelCustomizationJobOutput.retryCount) &&
        Objects.equals(this.retryLimit, statusForGetModelCustomizationJobOutput.retryLimit) &&
        Objects.equals(this.trainingTokensPerEpoch, statusForGetModelCustomizationJobOutput.trainingTokensPerEpoch);
  }
  ...
  public String toString() {
    ...
    sb.append("class StatusForGetModelCustomizationJobOutput {\n");
