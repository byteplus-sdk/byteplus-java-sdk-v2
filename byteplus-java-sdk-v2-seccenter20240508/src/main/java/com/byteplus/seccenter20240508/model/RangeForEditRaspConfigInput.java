...
/**
 * RangeForEditRaspConfigInput
 */



public class RangeForEditRaspConfigInput {
  ...
  public RangeForEditRaspConfigInput agentIDList(List<String> agentIDList) {
    this.agentIDList = agentIDList;
    return this;
  }

  public RangeForEditRaspConfigInput addAgentIDListItem(String agentIDListItem) {
  ...
  **/
  ...
  public RangeForEditRaspConfigInput allHost(Boolean allHost) {
  ...
  **/
  ...
  public RangeForEditRaspConfigInput leafGroupIDs(List<String> leafGroupIDs) {
    this.leafGroupIDs = leafGroupIDs;
    return this;
  }

  public RangeForEditRaspConfigInput addLeafGroupIDsItem(String leafGroupIDsItem) {
  ...
  **/
  ...
  public RangeForEditRaspConfigInput singleGroupPath(String singleGroupPath) {
  ...
  **/
  ...
  public RangeForEditRaspConfigInput singleHostname(String singleHostname) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RangeForEditRaspConfigInput rangeForEditRaspConfigInput = (RangeForEditRaspConfigInput) o;
    return Objects.equals(this.agentIDList, rangeForEditRaspConfigInput.agentIDList) &&
        Objects.equals(this.allHost, rangeForEditRaspConfigInput.allHost) &&
        Objects.equals(this.leafGroupIDs, rangeForEditRaspConfigInput.leafGroupIDs) &&
        Objects.equals(this.singleGroupPath, rangeForEditRaspConfigInput.singleGroupPath) &&
        Objects.equals(this.singleHostname, rangeForEditRaspConfigInput.singleHostname);
  }
  ...
  public String toString() {
    ...
    sb.append("class RangeForEditRaspConfigInput {\n");
