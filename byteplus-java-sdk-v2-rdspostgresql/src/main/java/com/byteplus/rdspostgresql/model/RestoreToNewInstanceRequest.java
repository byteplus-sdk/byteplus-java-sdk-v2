...
import com.byteplus.rdspostgresql.model.ChargeInfoForRestoreToNewInstanceInput;
import com.byteplus.rdspostgresql.model.NodeInfoForRestoreToNewInstanceInput;
import com.byteplus.rdspostgresql.model.TagForRestoreToNewInstanceInput;
...
public class RestoreToNewInstanceRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowListIds, backupId, chargeInfo, instanceName, nodeInfo, projectName, restoreTime, srcInstanceId, storageSpace, storageType, subnetId, tags, vpcId);
  }
