...
import com.byteplus.privatelink.model.EndpointForDescribeVpcGatewayEndpointsOutput;
import com.byteplus.privatelink.model.GatewayEndpointForDescribeVpcGatewayEndpointsOutput;
...
public class DescribeVpcGatewayEndpointsResponse extends com.byteplus.model.AbstractResponse {
  @SerializedName("Endpoints")
  private List<EndpointForDescribeVpcGatewayEndpointsOutput> endpoints = null;

  @SerializedName("GatewayEndpoints")
  private List<GatewayEndpointForDescribeVpcGatewayEndpointsOutput> gatewayEndpoints = null;
  ...
  public DescribeVpcGatewayEndpointsResponse endpoints(List<EndpointForDescribeVpcGatewayEndpointsOutput> endpoints) {
  ...
  public DescribeVpcGatewayEndpointsResponse addEndpointsItem(EndpointForDescribeVpcGatewayEndpointsOutput endpointsItem) {
    if (this.endpoints == null) {
      this.endpoints = new ArrayList<EndpointForDescribeVpcGatewayEndpointsOutput>();
    }
  ...
  **/
  @Valid
  @Schema(description = "")
  public List<EndpointForDescribeVpcGatewayEndpointsOutput> getEndpoints() {
    return endpoints;
  }

  public void setEndpoints(List<EndpointForDescribeVpcGatewayEndpointsOutput> endpoints) {
    this.endpoints = endpoints;
  }

  public DescribeVpcGatewayEndpointsResponse gatewayEndpoints(List<GatewayEndpointForDescribeVpcGatewayEndpointsOutput> gatewayEndpoints) {
  ...
  public DescribeVpcGatewayEndpointsResponse addGatewayEndpointsItem(GatewayEndpointForDescribeVpcGatewayEndpointsOutput gatewayEndpointsItem) {
    if (this.gatewayEndpoints == null) {
      this.gatewayEndpoints = new ArrayList<GatewayEndpointForDescribeVpcGatewayEndpointsOutput>();
    }
  ...
  **/
  @Valid
  @Schema(description = "")
  public List<GatewayEndpointForDescribeVpcGatewayEndpointsOutput> getGatewayEndpoints() {
    return gatewayEndpoints;
  }

  public void setGatewayEndpoints(List<GatewayEndpointForDescribeVpcGatewayEndpointsOutput> gatewayEndpoints) {
    this.gatewayEndpoints = gatewayEndpoints;
  }
