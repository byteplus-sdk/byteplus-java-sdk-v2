...
import com.byteplus.id.model.DataForListUsersOutput;
...
public class ListUsersResponse extends com.byteplus.model.AbstractResponse {
  @SerializedName("Data")
  ...
  public ListUsersResponse data(List<DataForListUsersOutput> data) {
    this.data = data;
    return this;
  }

  public ListUsersResponse addDataItem(DataForListUsersOutput dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<DataForListUsersOutput>();
    }
  ...
  **/
  @Valid
  @Schema(description = "")
  public List<DataForListUsersOutput> getData() {
    return data;
  }
  ...
  **/
  ...
  public ListUsersResponse totalCount(Integer totalCount) {
