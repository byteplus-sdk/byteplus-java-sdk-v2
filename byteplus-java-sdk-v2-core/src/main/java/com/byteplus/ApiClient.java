...
import com.byteplus.endpoint.DefaultEndpointProvider;
...
public class ApiClient extends BaseClient{
    ...
    public ApiClient() {
        ...
        authentications.put(DefaultAuthentication, new ByteplusSign());
    ...
    public ApiClient setRegion(String region) {
        ...
        if (authentication instanceof ByteplusSign) {
            ByteplusSign byteplusSign = (ByteplusSign) authentication;
            byteplusSign.setRegion(region);
        }
        return this;
    }
    ...
    public void updateParamsForAuth(String[] authNames, List<Pair> queryParams, Map<String, String> headerParams, ServiceInfo serviceInfo, String payload) {
        for (String authName : authNames) {
            Authentication auth = authentications.get(authName);
            if (auth == null) throw new RuntimeException("Authentication undefined: " + authName);
            if (auth instanceof ByteplusSign) {
                ByteplusSign byteplusSign = (ByteplusSign) auth;
