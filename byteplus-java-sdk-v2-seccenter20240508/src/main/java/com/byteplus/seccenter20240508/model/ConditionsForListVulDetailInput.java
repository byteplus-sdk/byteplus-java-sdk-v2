...
/**
 * ConditionsForListVulDetailInput
 */



public class ConditionsForListVulDetailInput {
  ...
  public ConditionsForListVulDetailInput cloudProviders(List<String> cloudProviders) {
    this.cloudProviders = cloudProviders;
    return this;
  }

  public ConditionsForListVulDetailInput addCloudProvidersItem(String cloudProvidersItem) {
  ...
  **/
  ...
  public ConditionsForListVulDetailInput cveID(String cveID) {
    this.cveID = cveID;
    return this;
  }
  ...
  **/
  ...
  public ConditionsForListVulDetailInput ifHighAvailability(Boolean ifHighAvailability) {
  ...
  **/
  ...
  public ConditionsForListVulDetailInput isRealRiskVul(Boolean isRealRiskVul) {
  ...
  **/
  ...
  public ConditionsForListVulDetailInput leafGroupIDs(List<String> leafGroupIDs) {
    this.leafGroupIDs = leafGroupIDs;
    return this;
  }

  public ConditionsForListVulDetailInput addLeafGroupIDsItem(String leafGroupIDsItem) {
  ...
  **/
  ...
  public ConditionsForListVulDetailInput level(List<String> level) {
    this.level = level;
    return this;
  }

  public ConditionsForListVulDetailInput addLevelItem(String levelItem) {
    if (this.level == null) {
  ...
  **/
  ...
  public ConditionsForListVulDetailInput tag(List<String> tag) {
    this.tag = tag;
    return this;
  }

  public ConditionsForListVulDetailInput addTagItem(String tagItem) {
    if (this.tag == null) {
  ...
  **/
  ...
  public ConditionsForListVulDetailInput topGroupID(String topGroupID) {
  ...
  **/
  ...
  public ConditionsForListVulDetailInput vulnName(String vulnName) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ConditionsForListVulDetailInput conditionsForListVulDetailInput = (ConditionsForListVulDetailInput) o;
    return Objects.equals(this.cloudProviders, conditionsForListVulDetailInput.cloudProviders) &&
        Objects.equals(this.cveID, conditionsForListVulDetailInput.cveID) &&
        Objects.equals(this.ifHighAvailability, conditionsForListVulDetailInput.ifHighAvailability) &&
        Objects.equals(this.isRealRiskVul, conditionsForListVulDetailInput.isRealRiskVul) &&
        Objects.equals(this.leafGroupIDs, conditionsForListVulDetailInput.leafGroupIDs) &&
        Objects.equals(this.level, conditionsForListVulDetailInput.level) &&
        Objects.equals(this.tag, conditionsForListVulDetailInput.tag) &&
        Objects.equals(this.topGroupID, conditionsForListVulDetailInput.topGroupID) &&
        Objects.equals(this.vulnName, conditionsForListVulDetailInput.vulnName);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConditionsForListVulDetailInput {\n");
