...
import com.byteplus.vpc20250901.model.RouteTableForDescribeSubnetsOutput;
import com.byteplus.vpc20250901.model.TagForDescribeSubnetsOutput;
...
public class SubnetForDescribeSubnetsOutput {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, availableIpAddressCount, cidrBlock, creationTime, description, isDefault, projectName, routeTable, status, subnetId, subnetName, tags, totalIpv4Count, updateTime, vpcId, zoneId);
  }
