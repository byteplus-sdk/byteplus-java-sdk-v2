...
import com.byteplus.vpc20250901.model.TagForDescribeVpcsOutput;
...
public class VpcForDescribeVpcsOutput {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, cidrBlock, creationTime, description, dnsServers, isDefault, natGatewayIds, projectName, routeTableIds, secondaryCidrBlocks, securityGroupIds, status, subnetIds, tags, updateTime, vpcId, vpcName);
  }
