...
import com.byteplus.rdspostgresql.model.ChargeDetailForDescribeDBInstancesOutput;
import com.byteplus.rdspostgresql.model.EndpointForDescribeDBInstancesOutput;
import com.byteplus.rdspostgresql.model.TagForDescribeDBInstancesOutput;
...
public class InstanceForDescribeDBInstancesOutput {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addressObject, chargeDetail, createTime, dbEngineVersion, endpoints, instanceId, instanceName, instanceStatus, instanceType, nodeNumber, nodeSpec, projectName, regionId, storageSpace, storageType, subnetId, tags, vpcId, zoneId, zoneIds);
  }
