...
public class VpcConfigForGetRevisionOutput {
  ...
  **/
  ...
  public VpcConfigForGetRevisionOutput securityGroupIds(List<String> securityGroupIds) {
  ...
  **/
  ...
  public VpcConfigForGetRevisionOutput subnetIds(List<String> subnetIds) {
