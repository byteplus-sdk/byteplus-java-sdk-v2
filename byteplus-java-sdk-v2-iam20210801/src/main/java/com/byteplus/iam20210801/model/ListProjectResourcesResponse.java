...
package com.byteplus.iam20210801.model;

import java.util.Objects;
import java.util.Arrays;
import com.byteplus.iam20210801.model.ProjectResourceForListProjectResourcesOutput;
...
public class ListProjectResourcesResponse extends com.byteplus.model.AbstractResponse {
  ...
  private List<ProjectResourceForListProjectResourcesOutput> projectResources = null;
  ...
  **/
  ...
  public ListProjectResourcesResponse projectResources(List<ProjectResourceForListProjectResourcesOutput> projectResources) {
    this.projectResources = projectResources;
    return this;
  }

  public ListProjectResourcesResponse addProjectResourcesItem(ProjectResourceForListProjectResourcesOutput projectResourcesItem) {
    if (this.projectResources == null) {
      this.projectResources = new ArrayList<ProjectResourceForListProjectResourcesOutput>();
    }
  ...
  **/
  @Valid
  @Schema(description = "")
  public List<ProjectResourceForListProjectResourcesOutput> getProjectResources() {
    return projectResources;
  }

  public void setProjectResources(List<ProjectResourceForListProjectResourcesOutput> projectResources) {
    this.projectResources = projectResources;
  }
