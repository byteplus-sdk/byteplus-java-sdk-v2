...
import com.byteplus.vpc20250901.model.TagForDescribeVpcAttributesOutput;
...
public class DescribeVpcAttributesResponse extends com.byteplus.model.AbstractResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, cidrBlock, creationTime, description, dnsServers, isDefault, natGatewayIds, projectName, requestId, routeTableIds, secondaryCidrBlocks, securityGroupIds, status, subnetIds, tags, updateTime, vpcId, vpcName);
  }
