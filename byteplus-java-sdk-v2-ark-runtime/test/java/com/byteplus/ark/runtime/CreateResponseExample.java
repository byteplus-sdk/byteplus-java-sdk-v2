...
import com.byteplus.ark.runtime.model.responses.tool.*;
import com.byteplus.ark.runtime.model.responses.tool.mcp.MCPRequireApproval;
...
public class CreateResponseExample {
    ...
    public static void main(String[] args) {
        ...
        CreateResponsesRequest request2 = CreateResponsesRequest.builder()
                ...
                .instructions("Please respond in English")
                .input(ResponsesInput.builder().stringValue("What did I say earlier？").build())
                ...
                .input(ResponsesInput.builder().addListItem(
                        ItemEasyMessage.builder().role(ResponsesConstants.MESSAGE_ROLE_USER).content(
                                MessageContent.builder()
                                        ...
                                        .addListItem(InputContentItemText.builder().text("Describe this image").build())
                                        .build()
                        ).build()
                ).build())
                .thinking(ResponsesThinking.builder().type(ResponsesConstants.THINKING_TYPE_ENABLED).build())
        ...
        CreateResponsesRequest request5 = CreateResponsesRequest.builder()
                ...
                .input(ResponsesInput.builder().stringValue("check and describe this repo structure repo的strcuture expressjs/express ").build())
                .thinking(ResponsesThinking.builder().type(ResponsesConstants.THINKING_TYPE_ENABLED).build())
                .build();
