...
import com.byteplus.cloudmonitor.model.DataForListAlertTemplatesOutput;
...
public class ListAlertTemplatesResponse extends com.byteplus.model.AbstractResponse {
  @SerializedName("Data")
  ...
  public ListAlertTemplatesResponse addDataItem(DataForListAlertTemplatesOutput dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<DataForListAlertTemplatesOutput>();
    }
  ...
  **/
  @Valid
  @Schema(description = "")
  public List<DataForListAlertTemplatesOutput> getData() {
    return data;
  }

  public void setData(List<DataForListAlertTemplatesOutput> data) {
    this.data = data;
  }
